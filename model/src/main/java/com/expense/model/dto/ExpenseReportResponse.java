...
public class ExpenseReportResponse {
    ...
    public ExpenseReportResponse(BigDecimal totalAmount, Long expenseCount, 
                                Map<String, BigDecimal> categorySubtotals,
    ...
    public Map<String, BigDecimal> getCategorySubtotals() {
        return categorySubtotals;
    }
    
    public void setCategorySubtotals(Map<String, BigDecimal> categorySubtotals) {
        this.categorySubtotals = categorySubtotals;
    }
